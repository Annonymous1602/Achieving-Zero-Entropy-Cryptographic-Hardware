...
module karatsuba_2 #(
    ...
    input  [N-1:0]   A,
    input  [N-1:0]   B,
    output [2*N-1:0] P_reg
);

    localparam H = N/2;

    wire [H:0] A0, A1, B0, B1;
    ...
    assign A0 = {1'b0, A[H-1:0]};
    assign A1 = {1'b0, A[N-1:H]};
    assign B0 = {1'b0, B[H-1:0]};
    assign B1 = {1'b0, B[N-1:H]};
    ...
    assign term0 = {{N{1'b0}}, T1};
    assign term1 = {{N{1'b0}}, T3 + T1 + T2} << H;
    assign term2 = {{N{1'b0}}, T2} << N;

    assign P_reg = term2 + term1 + term0;
