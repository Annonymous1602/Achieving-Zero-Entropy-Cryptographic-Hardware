...
BENCHMARK = os.environ.get('BENCHMARK', 'reconfig_bmm_128')
TASK = BENCHMARK
LAYOUT = 20
...
BLOCKS = ['BOOTH']
DEFAULT_FALLBACK_BOOTH = int(os.environ.get('DEFAULT_FALLBACK_BOOTH', '0'))
AUTO_SAFE_BOOTH_SITE_COUNT = int(os.environ.get('AUTO_SAFE_BOOTH_SITE_COUNT', '128'))
BLOCK_HEIGHT = 4
BLOCKS_COUNT = {}
MAX_BLOCKS_COUNT = {}
...
PRIORITY_CLBS = 10
GENERATIONS = int(os.environ.get('GENERATIONS', '25'))
POP_SIZE = int(os.environ.get('POP_SIZE', '25'))
